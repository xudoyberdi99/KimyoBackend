...
@NoArgsConstructor
@Data
@Entity(name = "center_departments_employees")
public class CenterAndDepartmentsEmployees extends BaceEntity {
    ...
    private CenterAndDepartments centerAndDepartments;
}
